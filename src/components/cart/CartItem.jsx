    ...
    <>
      ...
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          {/* open name and quantity counter */}
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              ...
              <div className=" bg-theme-cart rounded font-medium text-xs w-7 h-6 text-white lg:h-5 lg:w-6 flex items-center justify-center">
                {cartQuantity}
              </div>
          ...
          {/*close name and quantity counter */}
        </div>
        {/* open delete action and price */}
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center  justify-center">
            <button type="button" className="bg-theme-cart rounded  p-1 lg:p-0.5 text-white grid items-center justify-items-center cursor-pointer" onClick={onRemoveItem}>
              <TrashIcon className="w-5 h-5" />
            </button>
          </div>
        </div>
        {/* close delete action and price */}
      </div>
